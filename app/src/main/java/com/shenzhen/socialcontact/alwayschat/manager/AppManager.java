package com.shenzhen.socialcontact.alwayschat.manager;
...
public class AppManager
{
    ...
    public void addActivity(Activity activity)
    {
        ...
        KLog.d("存在activity个数： " + activityStack.size());

        for (Activity at : activityStack)
        {
            KLog.d("当前存在的activity为： " + at.getClass().getSimpleName());
        }
    }
    ...
    public void finishActivity()
    {
        ...
        for (Activity at : activityStack)
        {
            KLog.d("当前存在的activity为： " + at.getLocalClassName());
        }
    }
    ...
    /** 结束所有Activity,返回到登录界面 */
    public boolean finishToFirstActivity()
    {
//        Activity loginActivity = getActivity(LoginActivity.class.getSimpleName());
