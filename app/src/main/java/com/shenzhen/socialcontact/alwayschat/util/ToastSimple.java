package com.shenzhen.socialcontact.alwayschat.util;
...
public class ToastSimple
{
    ...
    private static ToastSimple makeText(CharSequence text, double time)
    {
        ...
        toast1.setTime(time);
        toast1.setToast(Toast.makeText(Chat.app(), text, Toast.LENGTH_SHORT));
        handler = new Handler(Chat.app().getMainLooper());
        return toast1;
    }
    ...
    public static ToastSimple makeText(int gravity, double time, View view)
    {
        ...
        ToastSimple toast1 = new ToastSimple();
        toast1.setTime(time);
        toast1.setToast(Toast.makeText(Chat.app(), "", Toast.LENGTH_SHORT), view);
        handler = new Handler(Chat.app().getMainLooper());
        return toast1;
    }
